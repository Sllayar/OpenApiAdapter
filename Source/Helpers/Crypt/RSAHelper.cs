...
namespace RFI.Helpers.Crypt
{
    ...
    {
        public static string Sign(string data, string keyPrivateString)
        {
            using(var privateKeyRsaProvider = CreateRsaProviderFromPrivateKey(keyPrivateString))
            {
        ...
        public static string Decrypt(string cipherText, string keyPrivateString)
        {
            using(var privateKeyRsaProvider = CreateRsaProviderFromPrivateKey(keyPrivateString))
            {
                var data = Convert.FromBase64String(cipherText);
                var decryptedBytes = privateKeyRsaProvider.Decrypt(data, RSAEncryptionPadding.Pkcs1);
        ...
        public static string Encrypt(string text, string keyPublicString)
        {
            using(var publicKeyRsaProvider = CreateRsaProviderFromPublicKey(keyPublicString))
            {
